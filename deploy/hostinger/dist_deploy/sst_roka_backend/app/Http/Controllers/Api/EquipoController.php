...
class EquipoController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        $query = Equipo::where('empresa_id', $request->user()->empresa_id)
            ->with(['area:id,nombre', 'responsable:id,nombres,apellidos', 'equipoCatalogo:id,nombre,codigo']);
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json($equipo->load(['area:id,nombre', 'responsable:id,nombres,apellidos', 'equipoCatalogo:id,nombre,codigo']), 201);
    }
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $equipo->update($data);
        return response()->json($equipo->load(['area:id,nombre', 'responsable:id,nombres,apellidos', 'equipoCatalogo:id,nombre,codigo']));
    }
